		...
		constructView: function(BaseView){
			return BaseView.extend({
				...
				getParamMethods: function(){
					...
					{ name: 'assertEqual', paramsNum: 1, limit: null },
					{ name: 'assertNotEqual', paramsNum: 1, limit: null },
					{ name: 'assertIs', paramsNum: 1, limit: null },
					{ name: 'assertIsNot', paramsNum: 1, limit: null },
					{ name: 'assertIn', paramsNum: 1, limit: 'list' },
					{ name: 'assertNotIn', paramsNum: 1, limit: 'list' },
					{ name: 'assertIsInstance', paramsNum: 1, limit: null },
					{ name: 'assertNotIsInstance', paramsNum: 1, limit: null },
					{ name: 'assertAlmostEqual', paramsNum: 1, limit: null },
					{ name: 'assertNotAlmostEqual', paramsNum: 1, limit: null },
					{ name: 'assertGreater', paramsNum: 1, limit: null },
					{ name: 'assertGreaterEqual', paramsNum: 1, limit: null },
					{ name: 'assertLess', paramsNum: 1, limit: null },
					{ name: 'assertLessEqual', paramsNum: 1, limit: null },
					{ name: 'assertRegexpMatches', paramsNum: 1, limit: null },
					{ name: 'assertNotRegexpMatches', paramsNum: 1, limit: null },
					{ name: 'assertItemsEqual', paramsNum: 1, limit: null },
					{ name: 'assertDictContainsSubset', paramsNum: 1, limit: 'dict' },
					{ name: 'assertMultiLineEqual', paramsNum: 1, limit: 'str' },
					{ name: 'assertSequenceEqual', paramsNum: 1, limit: 'str' },
					{ name: 'assertListEqual', paramsNum: 1, limit: 'list' },
					{ name: 'assertDictEqual', paramsNum: 1, limit: 'dict' }]
